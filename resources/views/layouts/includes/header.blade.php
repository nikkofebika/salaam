	...
	<div class="container-fluid container-xl d-flex align-items-center justify-content-between">
		...
		<nav id="navbar" class="navbar">
			<ul>
				...
				<li class="dropdown"><a class="@if($active_menu == 'about' || $active_menu == 'contact-us') active @endif" href="javascript:void(0)"><span>More</span> <i class="bi bi-chevron-down"></i></a>
					<ul>
